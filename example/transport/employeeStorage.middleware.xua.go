// Code generated by "xua server" from employee.go. DO NOT EDIT.
package transport
...
type employeeStorageCreate func(ctx context.Context, name string, userAgent string, bio string) (id int, err error)
type employeeStorageRead func(ctx context.Context, id int) (employee types.Employee, err error)
type employeeStorageUpdate func(ctx context.Context, id int, vacationDays int, bio string) (err error)
